...
""" Media.movie constructors are created to instantiate the movie objects.
 These values will be passed to the Movie class which is present in Media file. """


two_pointO = media.Movie("2.0", 
                        "2.0 is a 2018 Indian Tamil-language science fiction action film",
...
mersal = media.Movie("Mersal",
                    "A Story of twins , as a magician and as a doctor", 
                    "https://upload.wikimedia.org/wikipedia/en/5/5c/Mersal_Theatrical_Release_Poster.jpg",
                    "https://www.youtube.com/watch?v=gQDo5QuZTaw")
petta = media.Movie("Petta",
                    "A Story of Hostel warden. Marana Mass Action film",
                    "https://upload.wikimedia.org/wikipedia/en/c/c3/Petta_poster.jpg",
                    "https://www.youtube.com/watch?v=FCB0ZfQ9Rzs")
CCV = media.Movie("Chekka Chivantha Vanam",
                  "A Story of Don and his three sons fighting to acquire the position of Don",
                  "https://upload.wikimedia.org/wikipedia/en/3/3e/Chekka_Chivantha_Vaanam.jpg",
                  "https://www.youtube.com/watch?v=x2q5w-ThJeE")
Vikram_Vedha= media.Movie("Vikram Vedha",
                          "War between a police officer and a criminal",
