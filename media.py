...
class Movie():
	...
	movie_storyline : str
    Movie storyline should be passed as String with the one liner description about the movie.
	poster_image : str
    URL to the poster should be passed as String. Respected movies poster image URL should be passed here.
	trailer_youtube : str
